    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (servicesResponse.success && servicesResponse.data) {
          ...
          // Service configurations with logos
          ...
          if (SHOW_ALL_SERVICES_FOR_TESTING) {
            // Development mode: show all services
            services.push(
              serviceConfigs.knowlarity,
              serviceConfigs.voxbay,
              serviceConfigs.smartflo,
              serviceConfigs.smartflo_ivr,
              serviceConfigs.callerdesk
            );
          } else {
            // Production mode: only show configured services
