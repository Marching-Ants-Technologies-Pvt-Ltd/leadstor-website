...
export default function JoineePaymentForm({ payment_id }) {
    ...
    const handleKeyUp = (key, value) => {
        ...
        if (['cgst', 'sgst', 'discount'].includes(key)) {
            setTimeout(handleCalculation, 300);
        }
    };
    ...
    useEffect(() => {
        ...
        .then(([filterParams, courseFee, subServices, batch, currencyList, candidateInfoRaw]) => {
            ...
            setCandidate({
                ...candidateInfo,
                cgst: candidateInfo?.cgst ?? '9',
                sgst: candidateInfo?.sgst ?? '9'
            });
                    ...
                    <div className="bg-white border border-gray-200 rounded-[10px] p-5">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <InputTextWithIcon
                                ...
                                prefix="%"
                                type="number"
                                value={candidate?.cgst ?? '9'}
                                helper="CGST percentage"
                                cbOnChange={handleKeyUp}
                                fieldName='cgst'
                            />
                            ...
                            <InputTextWithIcon
                                ...
                                prefix="%"
                                type="number"
                                value={candidate?.sgst ?? '9'}
                                helper="SGST percentage"
                                cbOnChange={handleKeyUp}
                                fieldName='sgst'
                            />
