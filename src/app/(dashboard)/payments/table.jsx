                ...
                <tbody className="divide-y">
                    {rows.map(item => (
                        <tr className="hover:bg-slate-50" key={item?.id}>
                            ...
                            <td className="p-2">{item?.name || '-'} <span className='cursor-pointer' onClick={(e) => router.push(`/payments/${item.id}/edit`)}>✏️</span></td>
                                ...
                                <div className='flex justify-left align-middle gap-2'>
                                    ...
                                    {(item?.mobile || '').length > 3 &&
                                        <a className='mt-0.5' target='_blank' href={'https://wa.me/' + item.mobile + '?text=hello'}>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" color="#4CAF50" fill="none" stroke="#4CAF50" stroke-width="1.5" stroke-linejoin="round">
                            ...
                            <td className="p-2 text-right">
                                ...
                                {(item?.pendingAmount || '0') !== "0" && (
                                    <span title='Payment Over Due' className='text-lg cursor-pointer'>🚨</span>
                                )}
                            </td>
